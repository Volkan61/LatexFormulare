...
\begin{document}
	...
	\customerStreet \\ \customerZIP \ \customerCity}
		    ...
		    \begin{invoice}{Euro}{16}
			    \input{_invoice}
		    \end{invoice}
		\ps 
	    % Zahlungsbedingungen: 7 Tage bei 3 \% Skonto

	    Zahlungsbedingungen: 30 nach Rechnungseingang fällig ohne Skonto

		\closing{\invoiceClosing}
		\invoiceEnclosures

		\ps 
		Anlage: vom Projektleiter unterzeichneter Stundennachweis
